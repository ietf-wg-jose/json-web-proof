...
The [JSON Web Proof (JWP)](https://www.ietf.org/archive/id/draft-jmiller-jose-json-web-proof-01.html) draft establishes a new secure container format that supports selective disclosure and unlinkability using Zero-Knowledge Proofs (ZKPs) or other cryptographic algorithms.
