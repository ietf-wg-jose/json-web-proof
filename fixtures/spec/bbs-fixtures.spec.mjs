...
async function assertKeyStructure(basePath, { expectProofAlg }) {
    ...
    if (expectProofAlg) {
        ...
        expect(privateJwk.alg).toBe("BBS");
    }
...
describe("BBS fixture compatibility", () => {
    it("verifies MATTR legacy vectors with the new library", async () => {
        ...
        await assertKeyStructure(legacyPath, { expectProofAlg: false });
    ...
    it("verifies outputs generated by the migrated scripts", async () => {
        ...
        await assertKeyStructure(buildPath, { expectProofAlg: true });
